    ...
    <main className="container mx-auto px-4 py-8">
      ...
      <section className="mt-12">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-lg shadow">Fashion</div>
          <div className="bg-white p-6 rounded-lg shadow">Electronics</div>
          <div className="bg-white p-6 rounded-lg shadow">Beauty</div>
        </div>
      </section>
    </main>
  )
